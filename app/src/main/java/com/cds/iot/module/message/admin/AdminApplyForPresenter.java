 ...
 */
public class AdminApplyForPresenter implements AdminApplyForContract.Presenter {
    public final static String TAG = "AdminApplyForPresenter";
    private AdminApplyForContract.View view;
    private HttpApi mHttpApi;
    private CompositeDisposable mCompositeDisposable;

    public AdminApplyForPresenter(AdminApplyForContract.View view) {
        this.view = view;
    ...
    @Override
    public void processMessage(String update_user_id, String deviceId, String type) {
        ...
        ManageDeviceReq req = new ManageDeviceReq(userId, ids, deviceId, type);
